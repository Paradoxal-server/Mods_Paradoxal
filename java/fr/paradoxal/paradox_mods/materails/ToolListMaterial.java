...
public class ToolListMaterial {
	...
	public static ToolMaterial dragon_material = EnumHelper.addToolMaterial("dragon_material",3,6000,21.0F,0.0F,10);
	...
	public static ToolMaterial dragon_material_sword = EnumHelper.addToolMaterial("dragon_material_sword",3,6000,21.0F,8.5F,10);
}
