...
public class ModItems {
    ...
    public static Item dragon_ruby, dragon_ingot, astrral_core;
    ...
    public static void init() {
        ...
        dragon_ruby = new ItemBasic("dragon_ruby");
        dragon_ingot = new ItemBasic("dragon_ingot");
        astrral_core = new ItemBasic("astrral_core");

        items = new Item[]{
                logo, paradoxal_ruby, lunar_ruby, solar_ruby, dark_ruby, paradoxal_ingot, lunar_ingot, solar_ingot, dark_ingot, small_coal,
                paradoxal_dust, lunar_dust, solar_dust, dark_dust, dragon_ruby, dragon_ingot, astrral_core
        };
    }
