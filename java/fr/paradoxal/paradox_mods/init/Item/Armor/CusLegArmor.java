...
public class CusLegArmor extends ItemArmor{
    public CusLegArmor(String name, ItemArmor.ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
